...
**ChatMe** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
- [x] Stopped fetching new data from parse when logout pressed.
...
<img src='/gifs/ChatApp.gif?raw=true' title='Video Walkthrough' width='' alt='Video Walkthrough' />
